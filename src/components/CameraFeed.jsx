...
// const GESTURE_ICON = { ROTATE:'✋ Aylantirish', ZOOM:'↔️ Zoom', SELECT:'☝️ Tanlash', PINCH:'🤏 Pinch', GRAB:'✊ Ushlab', THUMBS_UP:'👍', IDLE:'' };

// export default function CameraFeed({ videoRef, landmarks, gesture, confidence, pinchNorm, isTracking, handsCount, fps, error, status }) {
...
//     // Draw pinch line (thumb tip ↔ index tip)
...
//   const statusLabels = { idle:'TAYYOR', loading:'YUKLANMOQDA', active:'ACTIVE', error:'XATO' };
...
//           ✋×{handsCount} {confidence > 0 ? `${Math.round(confidence*100)}%` : ''}
//         </div>
//       )}
...
//         background:'rgba(0,0,0,0.82)', padding:'4px 8px',
...
//           <span style={{ color:'#ffd700', marginLeft:4 }}>{GESTURE_ICON[gesture] || gesture}</span>
//         )}
